...
// console.log(createMenuItem('soup', 5, 'Lunch'));
// console.log(createMenuItem('curry', 12, 'Dinner'));
...
// reviews.push({name: "Brian", rating: 5, feedback: "Amazing!!! Could not be better." })
// console.log(reviews);
